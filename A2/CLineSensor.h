...
// Its mounting position is expressed in robot-local coordinates. The sensor
// transforms that point into world coordinates and asks CMap whether it lies
// within the five-unit-wide floor line.
//-----------------------------------------------------------------------------
class CLineSensor
{
    public:
        ...
        // over the floor line represented by aMap.
        bool IsOnLine(
